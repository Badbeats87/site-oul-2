...
function initializeModals() {
    ...
    const closeSubmissionBtn = document.querySelector('[data-close-submission-modal]');
    ...
    const closeInventoryBtn = document.querySelector('[data-close-inventory-modal]');
    ...
    document.addEventListener('keydown', (e) => {
        if (e.key === 'Escape') {
            const openModal = document.querySelector('[data-submission-details-modal][style*="display: flex"], [data-inventory-edit-modal][style*="display: flex"]');
